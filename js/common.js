...
function addToCart(goodsId, parentId)
{
  ...
  var custom_attr  = new Array();
  var number       = 1;
  var formBuy      = document.forms['ECS_FORMBUY'];
  var quick		   = 0;

  if(formBuy.elements['attrColor'].value == '' || typeof(formBuy.elements['attrColor'].value) == 'undefined') {
    alert('Please complete your color before adding to cart.');
    return false;    
  }else if(formBuy.elements['custom'].checked == false && (formBuy.elements['attrSize'].value == '' || typeof(formBuy.elements['attrSize'].value) == 'undefined')) {
    alert('Please complete your bust size before adding to cart.');
    return false;
  }
  color_size[0] = formBuy.elements['attrColor'].value;
  ...
  if(formBuy.elements['custom'].checked == true) {
    if(formBuy.elements['cus_shoulder_width'].value == '') {
        ...
        return false;
    } else if(formBuy.elements['cus_bust_size'].value == '') {
        alert('Please enter bust size.');
        return false;
    } else if(formBuy.elements['cus_waist_size'].value == '') {
        alert('Please enter waist size.');
        return false;
    } else if(formBuy.elements['cus_hip_size'].value == '') {
        alert('Please enter hip size.');
        return false;
    } else if(formBuy.elements['cus_hollow_to_floor'].value == '') {
        alert('Please enter Hollow to floor.');
        return false;
  ...
  goods.number   = number;
  goods.color_size   = color_size;
  goods.custom_attr   = custom_attr;
